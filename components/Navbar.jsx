    ...
    <nav className="w-full fixed top-0 z-50 border-b border-solid border-black/[.08] bg-white/80 backdrop-blur dark:border-white/[.145] dark:bg-black/80">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex md:items-center md:gap-2">
          <a
            href="/chat"
            className="px-4 py-2 text-sm font-medium text-foreground hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md transition-colors"
          >
            Nomor 3
          </a>
          <a
      ...
      >
        <div className="flex flex-col p-4 space-y-2">
          <a
            ...
            className="block px-4 py-3 text-base font-medium text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
          >
            Nomor 3
          </a>
          <a
